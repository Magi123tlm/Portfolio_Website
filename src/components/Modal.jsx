...
const Modal = ({ isModal, setIsModal }) => {
  ...
  return (
    <div className="z-30 max-[475px]:h-[80%] max-[475px]:w-[90%]  absolute h-[85%] w-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col lg:flex-row bg-[#1c1d25] dark:bg-[#ebebeb] rounded-[20px] shadow-[1px_1px_20px_5px_rgba(255,255,255,0.5)] dark:shadow-[1px_1px_20px_5px_rgba(0,0,0,0.5)] text-[#f1f1f1] dark:text-[#4c4f65]">
      <div className="flex-1 flex flex-col max-[475px]:px-5 max-[475px]:py-5 px-10 py-5 justify-center">
        <h3 className="w-full font-['Nunito'] text-[#1788ae] text-3xl font-bold mb-2">
          About Me.
        </h3>
        ...
        <p className="my-2 text-[12px] sm:text-[15px]">
          ...
          experiences & web applications. Actually for hire.
        </p>
        <ul className="hidden sm:flex flex-wrap my-2">
        ...
        <div className="flex items-center justify-evenly mt-3 gap-8 text-[12px] sm:text-[15px] max-[475px]:flex-wrap">
          <div className="relative flex flex-col justify-center items-center gap-1.5">
            <svg
              ...
              className="max-[475px]:h-7 max-[475px]:w-7 h-9 w-9 sm:h-12 sm:w-12 hover:rotate-360 duration-1000 ease-in-out "
            >
              <g fill="#61dafb">
            ...
            <div className=" text-[#61dafb] font-medium dark:font-extrabold">
              React.js
            </div>
          </div>
          <div className="relative flex flex-col justify-center items-center gap-1.5">
            <svg
              ...
              className="max-[475px]:h-7 max-[475px]:w-7 h-9 w-9 sm:h-12 sm:w-12 hover:scale-120 duration-500 ease-in-out"
            >
              <g fill="#8CC84B">
            ...
            <div className=" text-[#8cc84b] font-medium dark:font-extrabold">
              Node.js
            </div>
          </div>
          <div className="relative flex flex-col justify-center items-center gap-1.5">
            <svg
              ...
              viewBox="0 0 32 32"
              fill="currentColor"
              className="dark:fill-[#4c4f65] fill-white max-[475px]:h-7 max-[475px]:w-7 h-9 w-9 sm:h-12 sm:w-12 hover:rotate-360 duration-1000 ease-in-out"
            >
              <g>
            ...
            <div className="text-[#ffffff]  font-medium dark:font-extrabold dark:text-[#4c4f65]">
              Express.js
            </div>
          </div>
          <div className="relative flex flex-col justify-center items-center gap-1.5">
            ...
            <div className=" text-[#47a248] :font-medium dark:font-extrabold">
              MongoDB
            </div>
          </div>
        </div>
      </div>
      <div className="flex-1 hidden lg:block my-auto w-full ">
        <img src={coderSVG} alt="bg" />
      </div>
      <button
        onClick={() => setIsModal((prev) => !prev)}
        className=" cursor-pointer absolute top-0 right-0 px-4 py-2 bg-gradient-to-l from-[#1595b6] to-[#1f2667e6] text-white dark:bg-gradient-to-l dark:from-[#f06449] dark:to-[#ef3636] rounded-tr-[20px] rounded-br-[8px] rounded-l-2xl"
      >
        Close Modal
      </button>
    </div>
