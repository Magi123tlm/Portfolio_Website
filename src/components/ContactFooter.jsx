  ...
  return (
    <>
      <section ref={ref} className="max-w-screen-xl mx-auto px-4 pb-12 mt-15">
        <h2 className="text-3xl sm:text-[40px] max-[475px]:mt-10 relative z-10 font-bold px-4 py-2 w-max mx-auto text-center text-[#1788ae] sm:border-2 border-[#1788ae] rounded-md">
          Let's Connect
        </h2>
      ...
      <footer className="flex flex-col items-center pb-10">
        <p className="text-xs text-gray-300 dark:text-[#4c4f65]">
          Himanshu Rawat © 2024
        </p>
        <div className="black-logo my-4">
          <img src={name_logo_white} className="w-28 h-12" alt="" />
        </div>
        <ul className="mx-auto flex items-center justify-center gap-8 text-[#b0b2c3] dark:text-[#4c4f65]">
          <li>
            <a
            ...
            >
              <svg
                className="w-5 hover:text-white dark:hover:text-[#121213] hover:scale-110"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
                <path
          ...
          {/* <li>
            <a href="">
              <svg
                className="w-5 hover:text-white dark:hover:text-[#121213]"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
                <path
